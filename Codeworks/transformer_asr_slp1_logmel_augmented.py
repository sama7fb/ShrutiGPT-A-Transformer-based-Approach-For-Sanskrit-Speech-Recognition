...
tokenizer_file = "tokenizer-slp1-2-sanskrit.json"
    ...
    for item in data:
        ...
        if augment and tf.random.uniform(()) < 0.7:  # Apply augmentation to 70% of files
            ...
            for aug_idx in range(1, num_augmentations + 1):
                ...
                temp_audio_path = f"/home/sysadm/samapankar/term_proj/datasets/final_slp1/augmented_files/aug_{base_name}_audio_{aug_idx}.wav"
...
if train_enable:
    train_data = GetData("/home/sysadm/samapankar/term_proj/datasets/final_slp1/train", 
                         "/home/sysadm/samapankar/term_proj/datasets/final_slp1/train.txt")
    test_data = GetData("/home/sysadm/samapankar/term_proj/datasets/final_slp1/test", 
                        "/home/sysadm/samapankar/term_proj/datasets/final_slp1/test.txt")
...
if(train_enable):
    ...
    history = model.fit(ds, callbacks=[display_cb, EarlyStoppingAtMinLoss(15), metric_tracker], epochs=20)
